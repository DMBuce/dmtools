...
var insanity = [
	...
	"fears the moon",
	"fears trees",
	"thinks it's a genius",
	"thinks it's gorgeous",
	"hates violence",
	"thinks it's invisible",
	"thinks it's invulnerable",
	"thinks it has {{monster_ability}}",
	"thinks it has {{monster_feature}}",
	"thinks it's {{monster_trait}}",
	"must sing",
	"has a newly {{personality}} personality",
	"says its thoughts",
	"sees dead people",
]
...
var npc = [
	"{{dude_adjective}} {{fullname}} {{dude_modifier}}",
	"{{fullname}} {{dude_modifier}}",
	"{{dude_adjective}} {{fullname}}",
	"{{fullname}} the {{dude_adjective}}",

	"{{dude_adjective}} {{name}} {{dude_modifier}}",
	"{{dude_adjective}} {{name}} {{dude_modifier}}",
	"{{name}} the {{dude_adjective}}",
	"{{name}} the {{dude_adjective}}",
	"{{dude_adjective}} {{name}}",
	"{{dude_adjective}} {{name}}",
]
...
var npc_goal = [
	...
	"who wants freedom",
	"who wants glory",
	"who wants to impress {{npc}}",
	"who wants infamy",
	"who wants to infiltrate {{faction}}",
	"who wants justice",
	"who wants to kidnap {{npc}}",
	"who wants to lead {{faction}}",
	"who wants learning",
	"who wants to locate {{npc}}",
	"who wants love",
	"who wants mastery",
	"who wants power",
	"who wants to reach location",
	"who wants to rescue {{npc}}",
