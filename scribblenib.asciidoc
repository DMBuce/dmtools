...
Starting at 2nd level, you gain Grit,
which is used to protect your stats when taking damage.
See the "Damage" section of the Combat rules for details.
...
Once per day, you can tend to your health
