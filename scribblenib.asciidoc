...
== Choose Grit or Training

Choose either 1 Grit or Training.

Grit lets you absorb damage, as described in the Combat section.
...
* A shield and chainmail shirt or a random spellbook
* 3 Gear
* 3 Supplies
...
[cols="1,1"]
|===
| Cost per syllable | Type of item
...
| 10gp
| Melee weapons, luxury items

| 20gp
| Ranged weapons

| 100gp
| Dangerous & exotic items
|===
