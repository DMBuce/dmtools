...
For example, a bear's stat block is "Bear ☐☐☐☐".
The rightmost three checkboxes represent the monster's stats
and other checkboxes represent Grit.

A monster can have fewer than three stats.
For example, a goblin's stat block might be "Goblin ☐".
A particularly weak stat block might have no stats,
e.g. "Goblin Minion",
